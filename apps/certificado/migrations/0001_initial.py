    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duracion_horas', models.CharField(help_text='Ej: 40 horas, 3 días', max_length=100, verbose_name='Duración')),
                ('fecha_inicio', models.DateField(verbose_name='Fecha de Inicio')),
                ('fecha_fin', models.DateField(verbose_name='Fecha de Fin')),
                ('fecha_emision', models.DateField(default=django.utils.timezone.now, verbose_name='Fecha de Emisión')),
                ('incluir_qr', models.BooleanField(default=False, help_text='Si se activa, se estampará un código QR único en cada certificado generado.', verbose_name='Incluir QR de Seguridad')),
                ...
                ('modalidad', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventos', to='certificado.modalidad', verbose_name='Modalidad')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='eventos', to='certificado.tipo', verbose_name='Tipo')),
                ('tipo_evento', models.ForeignKey(help_text='Descripción específica del tipo de evento', on_delete=django.db.models.deletion.PROTECT, related_name='eventos', to='certificado.tipoevento', verbose_name='Tipo de Evento')),
            ],
            options={
                'verbose_name': 'Evento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid_validacion', models.UUIDField(blank=True, default=uuid.uuid4, editable=False, null=True, unique=True, verbose_name='UUID de Validación')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['estudiante', 'estado'], name='certificado_estudia_f659fb_idx'), models.Index(fields=['estudiante'], name='certificado_estudia_b9a3e8_idx'), models.Index(fields=['estado'], name='certificado_estado_4738e5_idx')],
            },
        ),
